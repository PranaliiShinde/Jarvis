...
function takeCommand(message) {
    if (message.includes('hello') || message.includes('hello')) {
    ...
    } else if (message.includes("open my whatsapp")) {
        ...
        window.open(`https://www.google.com/maps/@19.9912214,73.806616,15z?entry=ttu`, );
        const finalText = "This is where I found on the Maps";
        speak(finalText);
    } else {
        window.open(`https://www.google.com/search?q=${message.replace(" ", "+")}`, "_blank");
